...
class FilterDialog extends Component {
  ...
  onPickFilter(filter) {  //Since we can't mutate the state directly
    ...
    this.setState({ pickedFilters: filtersCopy })
  }

  onQueryCombinationChanged(queryType) { this.setState({ queryCombination: queryType }) }
